package com.aliyasin.githubuser2.viewModel
...
import com.aliyasin.githubuser2.view.DetailActivity
    ...
    inner class ListDataHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(dataUsers: DataUsers) {
            with(itemView) {
                ...
                username.text = itemView.context.getString(R.string.aliyasin_dev, dataUsers.username)
