package com.aliyasin.githubuser2.view
...
import com.aliyasin.githubuser2.viewModel.ViewPagerDetailAdapter
...
class DetailActivity : AppCompatActivity() {
    ...
    private fun setData() {
        ...
        username.text = getString(R.string.aliyasin_dev, dataUser.username)
